...
namespace PSAP.PSAPCommon
{
    public class FtpOperations
    {
        ...
        public FtpOperations(string FtpServerIP, string FtpRemotePath, string FtpUserID, string FtpPassword)
        {
        ...
        public static void DeleteDirectory(string ftpServerIP, string folderToDelete, string ftpUserID, string ftpPassword)
        {
            try
            {
                ...
                {
                    FtpOperations fw = new FtpOperations(ftpServerIP, folderToDelete, ftpUserID, ftpPassword);
                    //进入订单目录
